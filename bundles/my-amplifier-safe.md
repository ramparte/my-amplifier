---
bundle:
  name: my-amplifier-safe
  version: 1.14.0
  description: SNAPSHOT of my-amplifier v1.14.0 (pre-optimization). Full bundle with all includes. Revert to this with 'amplifier bundle use my-amplifier-safe'.
